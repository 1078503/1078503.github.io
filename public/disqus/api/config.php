...
define('PUBLIC_KEY', 'YWViqEX8iRVgGy9FasRJCpqQahlhSoMWnWfcFdga9WTK4dhNkBQ7gRr2uqzdM2nK');
define('SECRET_KEY', 'zy5Dk02RfEk1S9FeptIzjL4hG1TBv85pYgE6GOFbR4vvukGQ8iEz85ceRpcbJCkc');
define('DISQUS_USERNAME', '1078503_org');
define('DISQUS_EMAIL', '1078503@gmail.com');
define('DISQUS_PASSWORD', 'tumuyichang');
define('DISQUS_WEBSITE', 'https://dtz9.net');
define('DISQUS_SHORTNAME', '1078503');
...
define('GRAVATAR_CDN', '//gravatar.loli.net/avatar/');
...
define('SMTP_USERNAME', 'noreply@dtz9.net');
define('SMTP_PASSWORD', 'tumuyichang');
define('SMTP_FROM', 'admin@dtz9.net');
define('SMTP_FROMNAME', '近视眼逛博客');
